...
>>>>>>> 12dfbafeb49ad628edc091a3515d6e0e6bfe3b67
library(tmap)
...
### `raster` package The package `raster` within its functions provides the access for all the world countries and regions. This function is `getData`. With this function we can get regions in spatial points (`sp`) class.
>>>>>>> 12dfbafeb49ad628edc091a3515d6e0e6bfe3b67
