...
In this section, we repeat the previous demo but this time using `rsat`. The aim is to have an overview of the package's workflow and show how downloading satellite images can be acomplished with a few lines of code. The process is very similar to the online portal; (1) specify *username* and *password*, (2) define the *ROI* and *TOI,* (3) search, and (4) download the search results.
...
1.  Compute the union, intersection, and contains operation with dates.
...
# union my.dates1,my.dates2,my.dates
all.dates <- unique(c(my.dates1,my.dates2,my.dates3))

# contains
my.dates1 %in% my.dates2
# intersection my.dates1, my.dates2
my.dates1[my.dates1 %in% my.dates2]

# length all dates
length(c(my.dates1,my.dates2,my.dates3))

# length all dates union
length(all.dates)
