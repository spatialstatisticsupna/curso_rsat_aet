...
red <- as.list(rsat_get_SpatRaster(volcano, "S2MSI2A", "redModified"))
blue <- as.list(rsat_get_SpatRaster(volcano, "S2MSI2A", "B02_60"))
green <- as.list(rsat_get_SpatRaster(volcano, "S2MSI2A", "B03_60"))
